...
<body>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate action="{{ route('register') }}"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                value="{{ old('name') }}" id="yourName" required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="number" class="form-control"
                                                value="{{ old('number') }}" id="yourPhone" required
                                                onkeypress="limitInputLength(); restrictInput(event);">
                                            <span class="text-danger">
                                                @error('number')
                                                    {{ $message }}
                                                @enderror
                            ...
                            <div class="credits">
                                Designed by <a href="">Akshaya Kalpa</a>
                            </div>
    ...
    <script>
        function limitInputLength() {
            const number = document.getElementById('yourPhone').value;
            const maxLength = 10;
        ...
        function restrictInput(event) {
            const data = document.getElementById('yourPhone').value;
